...
// Estados de error (opcional)
const errors = ref({
  email: '',
  password: ''
});

// Función de ejemplo para validar
const validateEmail = () => {
...
<template>
  <div class="max-w-md mx-auto p-6 space-y-6">
    <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Formulario de Ejemplo</h2>
...
<!-- Input readonly -->
<BaseInput
    model-value="Campo de solo lectura"
    label="Solo lectura"
    readonly
/>

<!-- Input de teléfono sin label -->
<BaseInput
    v-model="telefono"
    type="tel"
...
<!-- Textarea usando el mismo componente -->
<BaseInput
    v-model="mensaje"
